  ...
  return (
    <div className="initial-page_wrapper">
      <div className="text_container">
        ...
        <p>
          {" "}
          In each quiz, you'll see pictures and your job is to draw boxes over
          the objects that you see.
        </p>
        <p>
          The more puzzles you solve, the better you will, so don't worry if it
          seems hard at first.
        </p>
        <p>We'll provide you with instructions.</p>
        <p> Good luck!</p>
      </div>
      <Button className="skip_button" onClick={handleSkip}>
        Skip
      </Button>
    </div>
  );
